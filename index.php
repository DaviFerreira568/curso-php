        ...
        <div class="conteudo">
            <nav class="modulos">
                <div class="modulo vermelho-escuro">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=classes_objetos&file=classes">
                                Primeira Classe
                            </a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=classes_objetos&file=desafio_ClasseData">
                                Desafio Data
                            </a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=classes_objetos&file=contrutor_destrutor">
